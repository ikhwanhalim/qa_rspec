  ...
  var methods = {
    init: function(settings) {
      return this.each(function() {
        ...
        self.heads.first().addClass('stepy-active active');
        ...
        // WIP...
            if (self.opt.titleClick) {
              self.heads.click(function() {
                var  array  = self.heads.filter('.stepy-active.active').attr('id').split('-'), // TODO: try keep the number in an attribute.
      ...
      that[0].heads.removeClass('stepy-active active').eq(max).addClass('stepy-active active');
